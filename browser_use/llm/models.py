...
# """
# OpenAI-only minimal models registry for browser_use.

# Drop-in replacement for browser_use/llm/models.py when you want to
# remove non-OpenAI providers entirely.
# """
...
# def build_openai(model: str, **kwargs) -> BaseChatModel:
#     """
#     Create a ChatOpenAI with environment-provided credentials.
#     """
#     api_key = _env("OPENAI_API_KEY")
#     organization = _env("OPENAI_ORG_ID") or _env("OPENAI_ORGANIZATION")
#     project = _env("OPENAI_PROJECT")
...
# # ---------- Common presets you actually use ----------

# openai_gpt_4o       = lambda **kw: build_openai("gpt-4o", **kw)
# openai_gpt_4o_mini  = lambda **kw: build_openai("gpt-4o-mini", **kw)
# openai_o1           = lambda **kw: build_openai("o1", **kw)
# openai_o1_mini      = lambda **kw: build_openai("o1-mini", **kw)
# openai_o3           = lambda **kw: build_openai("o3", **kw)
# openai_o3_mini      = lambda **kw: build_openai("o3-mini", **kw)
# openai_o3_pro       = lambda **kw: build_openai("o3-pro", **kw)
# openai_o4_mini      = lambda **kw: build_openai("o4-mini", **kw)
# openai_gpt_5        = lambda **kw: build_openai("gpt-5", **kw)
# openai_gpt_5_mini   = lambda **kw: build_openai("gpt-5-mini", **kw)
# openai_gpt_5_nano   = lambda **kw: build_openai("gpt-5-nano", **kw)

# # ---------- Back-compat helpers ----------

# def model_by_name(name: str, **kw) -> BaseChatModel:
#     """
#     Return an OpenAI model by compact name. Unknown names raise.
#     Examples:
#         model_by_name("openai_gpt_4o", temperature=0.2)
#         model_by_name("openai_o1_mini")
#     """
...
#         raise ValueError(f"Unknown or unsupported OpenAI model: {name}")
